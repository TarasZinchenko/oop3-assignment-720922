...
import nl.inholland.student.dto.tmdb.TmdbImageDto;
...
class MovieServiceTest {
    ...
    void setUp() {
        ...
        omdbMovieDto.setTitle("Inception");
        omdbMovieDto.setYear("2010");
        omdbMovieDto.setDirector("Christopher Nolan");
        omdbMovieDto.setGenre("Action, Sci-Fi");

        // Setup TMDB movie response
        tmdbMovieDto = new TmdbMovieDto();
        tmdbMovieDto.setId(27205L);
        tmdbMovieDto.setTitle("Inception");

        // Setup TMDB images response
        TmdbImageDto image1 = new TmdbImageDto();
        image1.setFilePath("/backdrop1.jpg");
        TmdbImageDto image2 = new TmdbImageDto();
        image2.setFilePath("/backdrop2.jpg");

        imageListDto = new TmdbImageListDto();
        imageListDto.setBackdrops(Arrays.asList(image1, image2));

        // Setup saved movie
        savedMovie = new Movie();
        savedMovie.setId(1L);
        savedMovie.setTitle("Inception");
        savedMovie.setYear("2010");
        savedMovie.setDirector("Christopher Nolan");
        savedMovie.setGenre("Action, Sci-Fi");
        savedMovie.setWatched(false);
        savedMovie.setRating(0);
    }
